...
<div class="container">
    ...
    <section class="profile-info">
        <h2>{{ $user->name }}</h2>
        <p><span class="label">البريد الإلكتروني:</span> <span class="value">{{ $user->email }}</span></p>
        <p><span class="label">الهاتف:</span> <span class="value">{{ $user->phone }}</span></p>
        <p><span class="label">الدور:</span> <span class="value">{{ $user->role }}</span></p>
        <p><span class="label">رقم الرخصة:</span> <span class="value">{{ $user->license_number }}</span></p>
        <p><span class="label">الوصف:</span> <span class="value">{{ $user->bio }}</span></p>
        <p><span class="label">مدعوم:</span> <span class="value">{{ $user->is_supported ? 'نعم' : 'لا' }}</span></p>
        <p><span class="label">الراتب:</span> <span class="value">{{ $user->salary }}</span></p>
        <p><span class="label">البنك:</span> <span class="value">{{ $user->bank }}</span></p>
        <p><span class="label">المدينة:</span> <span class="value">{{ $user->city }}</span></p>
